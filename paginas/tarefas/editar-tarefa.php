...
<header>
    <h3>
        <i class="bi bi-list-task"> Editar de Tarefa</i>
    </h3>
</header>
<div>
    <form class="needs-validation" action="index.php?menuop=atualizar-tarefa" method="post">
        ...
        <div class="mb-3">
            ...
            <textarea name="descricaoTarefa" id="" cols="30" rows="5" class="form-control"  required><?=$dados['descricaoTarefa']?></textarea>
        </div>
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <select name="recorrenciaTarefa" id="recorrenciaTarefa" class="form-select">
                    ...
                    <option value="4" <?php echo ($dados["recorrenciaTarefa"] == 4 )?'selected':""?>>Anualmenge</option>
                </select>
            </div>
