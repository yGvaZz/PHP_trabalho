<header>
    <h3>
        <i class="bi bi-calendar-check"> Cadastro de Evento</i>
    </h3>
</header>
<div>
    <form class="needs-validation" action="index.php?menuop=inserir-evento" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="descricaoEvento" id="" cols="30" rows="5" class="form-control" required></textarea>
        </div>
